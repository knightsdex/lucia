...
(function ($) {
  ...
  // 08. Nice Select Js
  $(
    ".tp-postbox-details-area select, .sidebar__wrapper select, .liko-footer-area select, .tp-shop-top-select select, .tp-shop-details-variation select"
  ).niceSelect();
  ...
  if ($("#tp-header-top__value-toogle").length > 0) {
    window.addEventListener("click", function (e) {
      if (
        document
          .getElementById("tp-header-top__value-toogle")
          .contains(e.target)
      ) {
  ...
  if ($("#tp-header-top__lang-toogle").length > 0) {
    window.addEventListener("click", function (e) {
      if (
        document.getElementById("tp-header-top__lang-toogle").contains(e.target)
      ) {
  ...
  if ($("#lineMarker").length > 0) {
    function tp_tab_line() {
      ...
      var item = document.querySelectorAll(
        ".tp-studio-portfolio-wrap .tp-studio-portfolio-item"
      );
      var itemActive = document.querySelector(
        ".tp-marker-tab .tp-studio-portfolio-item"
      );
      ...
      function anchorWidthCounter() {
        ...
        var aPadRight;
        var aTotalWidth;
        $(".tp-marker-tab .tp-studio-portfolio-item").each(function (
          index,
          elem
        ) {
          var activeTest = $(elem).hasClass("active");
  ...
  function ue() {
    e(".grid_12").each(function () {
      ...
      n.length && o.css("top", n.outerHeight() + "px"),
        Clb.isMobile
          ? setTimeout(function () {
        ...
        s.each(function () {
          ...
          a.find(".portfolio-item").on("mouseover mousemove", function (a) {
            ...
            if (Clb.isRtl)
              var v =
                e(this).offset().left + e(this).height() - t.offset().left - i;
            ...
            Clb.isRtl && (g -= u / 2),
              ...
              b > d / 1.5 && (c -= f),
              Clb.isMobile
                ? ((v = e(this).offset().top - t.offset().top),
                  (l[0].style.transform = "translateY(" + v + "px)"))
                : (l[0].style.transform = "translateX(" + v + "px)"),
              n.addClass("visible"),
              (n[0].style.transform = "translate(" + g + "px, " + c + "px)"),
              (h[0].style.transform = "rotate(" + w + "deg)"),
              (h[0].style.filter = "brightnes(" + w + ")"),
              setTimeout(function () {
                n.addClass("animate");
              }, 1),
              (p = a.clientX),
            ...
            a.find(".portfolio-item").on("mouseleave", function (e) {
              n.removeClass("visible"),
                (n[0].style.transform = "translate(0px, 0px)"),
                (h[0].style.transform = "rotate(0deg)"),
                setTimeout(function () {
  ...
  var wooRelatedProducts = new Swiper(
    ".tp-woo-related-product-related-active",
    {
      loop: true,
      slidesPerView: 3,
      spaceBetween: 30,
  ...
  $(".liko-team-modal-open-btn").on("click", function (e) {
    e.preventDefault();
    let modalContent = $(this)
      .closest(".liko-team-item")
      .siblings(".modal")[0].outerHTML;
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-header-04.default",
      header_menu
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-footer-lets-contact.default",
      footer_lets_contact
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-footer-menu.default",
      liko_menu_text_animation
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-full-screen-showcase-slider.default",
      showcase_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-full-screen-wrapper-slider.default",
      full_screen_wrapper_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-shop-hero-slider.default",
      tp_shop_hero_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-brand-slider.default",
      tp_brand_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-brand-grid.default",
      tp_brand_grid_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-team-box.default",
      tp_team_box
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-testimonial-slider.default",
      tp_testimonial_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-image-slider.default",
      tp_image_slider
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-animated-heading.default",
      tp_animated_heading
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-text-slider.default",
      tp_text_slider
    );
  });
})(jQuery);
